...
import { MeshLine } from "../node_modules/three/THREE.MeshLine.js"
...
document.addEventListener("DOMContentLoaded", function(event) { 
	...
	let cityMap: Array<Array<number>> = []
	...
	function getCityAt(x: number, y: number) {
		return city.map[4 * (x + (city.height - y) * city.width)]
		// return cityMap[x][y]
	}

	function vToString(v: THREE.Vector3) {
	...
	class Actor {
		...
		initialize(pos: THREE.Vector3 = null, angle: number = null, incrementNInitializedActors = true) {
